...
public class CalculadoraAlgebricaTest extends TestCase{
	...
	public void testDadoUmaExpressaoAlgebrica_100A_Igual_10B_Mais_20C_ESendo_A_Igual_1_E_B_Igual_2AoIsolar_C_deveRetonarAExpressao_C_Igual_4(){
		...
		expressaoAlgebrica.setVariavel(var1).setOperacao(EnumOperacaoesCalculadoraAlgebrica.IGUALDADE).setVariavel(var2).setOperacao(EnumOperacaoesCalculadoraAlgebrica.SOMA).setVariavel(var3);
	...
	public void testDadoUmaExpressaoAlgebrica_100A_Mais_10B_Igual_20C_ESendo_A_Igual_1_E_B_Igual_2AoIsolar_C_deveRetonarAExpressao_C_Igual_4(){
		...
		expressaoAlgebrica.setVariavel(var1).setOperacao(EnumOperacaoesCalculadoraAlgebrica.SOMA).setVariavel(var2).setOperacao(EnumOperacaoesCalculadoraAlgebrica.IGUALDADE).setVariavel(var3);
